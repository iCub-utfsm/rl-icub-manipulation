...
class iCubFeaturesExtractor(BaseFeaturesExtractor):
    def __init__(
        self,
        observation_space: gym.spaces.Dict,
        observable_keys: Union[Sequence[Text], Dict[Text, Sequence[Text]]] = None, #observables.CMU_HUMANOID_OBSERVABLES,
        ...
        if self._dict_observables:
            self._extractors = {
                k: iCubFeaturesExtractor(observation_space, obs_keys, obs_rms)
